...
export default function HomePage() {
  return (
    <div tw="h-screen overflow-hidden items-center justify-center flex container mx-auto">
      <div tw="flex flex-col">
        <div tw="flex items-center justify-center">
          <div tw="inline-flex items-center justify-center">
            <svg tw="h-7 sm:h-8" viewBox="0 0 55 31">
              <path
                clipRule="evenodd"
            ...
            <h3 tw="ml-3 text-gray-500 text-3xl font-semibold">Tailwind</h3>
          </div>
          <p tw="font-semibold text-4xl ml-4 text-gray-500">+</p>
          <div tw="inline-flex items-center justify-center">
            <svg tw="h-14 text-gray-300" viewBox="0 0 841.9 595.3">
              <g xmlns="http://www.w3.org/2000/svg">
                ...
                <circle cx="420.9" cy="296.5" fill="currentColor" r="45.7" />
                <polygon fill="currentColor" points="520.5,78.1 520.5,78.1 520.5,78.1  " />
              </g>
            </svg>
            <h3 tw="text-gray-500 text-3xl font-semibold">React</h3>
          </div>
        </div>
      </div>
    </div>
